...
public class FastCash extends JFrame implements ActionListener{
    ...
    FastCash(String pinnumber)
    {
       ...
       deposit.setBounds(150,425,150,30);
       deposit.addActionListener(this);
       image.add(deposit);
       
       withdrawl = new JButton("500");
       withdrawl.setBounds(355,425,150,30);
       withdrawl.addActionListener(this);
       image.add(withdrawl);
       
       fastcash = new JButton("1000");
       fastcash.setBounds(150,460,150,30);
       fastcash.addActionListener(this);
       image.add(fastcash);

       ministatement = new JButton("2000");
       ministatement.setBounds(355,460,150,30);
       ministatement.addActionListener(this);
       image.add(ministatement);

       pinchange = new JButton("5000");
       pinchange.setBounds(150,390,150,30);
